...
class  CoordgenMacrocycleBuilder
{
  public:
    ...
    /*assign coordinates by removing one bond, generating the coordinates of the resulting
     molecule and re-adding the missing bond*/
  ...
  private:
    /*
     precision of calculation. Higher values result in better results but longer calculation times
     */
    float m_precision;
    ...
    /* get restraints to try to avoid things like having eteroatoms or substituents
